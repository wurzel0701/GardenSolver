namespace GardenSolver
{
    internal class PlantTypeLibrary
    {
        ...
        public PlantTypeLibrary() 
        {
            ...
            AllPlants.Add(new PlantType("Erbse", PlantFamilyEnum.LEG, NutritionRequirementsEnum.LOW, new List<string>() { "Dill", "Fenchel", "Gurke", "Kohl", "Kohlrabi", "Kopfsalat", "Mais", "Paprika", "Radieschen", "Rettich", "Ringelblume", "Rote Bete", "Zucchine"}, new List<string>() { "Möhre" }, new List<string>() { "Ackerbohne", "Buschbohne", "Kartoffel", "Knoblauch", "Lauch", "Mangold", "Stangenbohne", "Tomate", "Zwiebel" }));
            ...
            AllPlants.Add(new PlantType("Kamille", PlantFamilyEnum.KOR, NutritionRequirementsEnum.LOW, new List<string>() { "Kohlrabi", "Kopfkohl", "Lauch", "Sellerie" }, new List<string>() { }, new List<string>() { }));
            AllPlants.Add(new PlantType("Kartoffel", PlantFamilyEnum.NAC, NutritionRequirementsEnum.HIGH, new List<string>() { "Ackerbohne", "Buschbohne", "Dill", "Kamille", "Kapuzinerkresse", "Kohl", "Blattkohl", "Kohlrabi", "Knoblauch", "Mais", "Minze", "Spinat" }, new List<string>() { "Ringelblume", "Tagetes", "Kümmel", "Meerrettich"}, new List<string>() { "Erbse", "Gurke", "Kürbis", "Paprika", "Rote Bete", "Sellerie", "Sonnenblume", "Tomate", "Chinakohl"}));
            ...
            AllPlants.Add(new PlantType("Lauch", PlantFamilyEnum.LIL, NutritionRequirementsEnum.MEDIUM, new List<string>() { "Endivie", "Erdbeere", "Gurke", "Kamille", "Kohl", "Blattkohl", "Kohlrabi", "Kopfsalat", "Möhre", "Pastinake", "Petersilie", "Radicchio", "Schwarzwurzel", "Tomate", "Zwiebel", "Zucchini"}, new List<string>() { "Rettich", "Sellerie", "Wermut" }, new List<string>() {"Buschbohne", "Erbse", "Rote Bete", "Stangenbohne", "Chinakohl"}));
            ...
            AllPlants.Add(new PlantType("Mangold", PlantFamilyEnum.GAE, NutritionRequirementsEnum.MEDIUM, new List<string>() { "Buschbohne", "Kohl", "Blattkohl", "Möhre", "Radieschen", "Rettich", "Kopfsalat", "Pflücksalat", "Feldsalat", "Eisbergsalat" }, new List<string>() { }, new List<string>() { "Rote Bete", "Spinat"}));
            ...
            AllPlants.Add(new PlantType("Petersilie", PlantFamilyEnum.DOL, NutritionRequirementsEnum.LOW, new List<string>() { "Erdbeere", "Knoblauch", "Lauch", "Radieschen", "Rettich", "Tomaten", "Zwiebel"}, new List<string>() { }, new List<string>() { "Dill", "Fenchel", "Kopfsalat", "Möhre", "Pastinake", "Salat", "Sellerie"}));
            AllPlants.Add(new PlantType("Pfefferminze", PlantFamilyEnum.LIP, NutritionRequirementsEnum.HIGH, new List<string>() { "Kartoffel", "Kohl", "Blattkohl", "Kopfsalat", "Pflücksalat", "Feldsalat", "Eisbergsalat", "Möhre", "Tomate" }, new List<string>() { }, new List<string>() { }));
            ...
            AllPlants.Add(new PlantType("Radieschen", PlantFamilyEnum.KRE, NutritionRequirementsEnum.LOW, new List<string>() { "Ackerbohne", "Buschbohne", "Erbse", "Erdbeere", "Kapuzinerkresse", "Kohl", "Kohlrabi", "Kresse", "Mangold", "Möhre", "Petersilie", "Pflücksalat", "Spinat", "Stangenbohne", "Tomate", "Zucchini"}, new List<string>() { "Kpfsalat" }, new List<string>() { "Gurke", "Zwiebel"}));
            ...
            AllPlants.Add(new PlantType("Rote Bete", PlantFamilyEnum.FUC, NutritionRequirementsEnum.HIGH, new List<string>() { "Bohnenkraut", "Buschbohne", "Fenchel", "Gurke", "Knoblauch", "Kohl", "Kohlrabi", "Koriander", "Pastinake", "Pflücksalat", "Tomaten", "Zucchini", "Zwiebel" }, new List<string>() { "Dill" }, new List<string>() { "Kartoffel", "Lauch", "Mais", "Mangold", "Möhre", "Spinat" }));
